...
namespace KeepLearning.Domain.Interfaces
{
    public interface ICountryService
    {
        ...
        public Task<Domain.Enteties.Country?> GetCountry(string questionText, GuessType.Category guessType);
        public Task<string> GetCorrectAnswer(string questionText, GuessType.Category guessType);
        public Task<IEnumerable<Domain.Enteties.Country>> GetCountries(IEnumerable<Continent.Name> continents);
        public bool IsCorrectAnswer(Domain.Enteties.Country country, string answerText, GuessType.Category guessType);
    }
}
